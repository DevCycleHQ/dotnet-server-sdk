...
namespace DevCycle.SDK.Server.Cloud.Api
{
    ...
    public sealed class DevCycleCloudClient : DevCycleBaseClient
    {
        ...
        )
        {
            ...
            evalHooksRunner = new EvalHooksRunner();
        }
        ...
        public override async Task<Variable<T>> Variable<T>(DevCycleUser user, string key, T defaultValue)
        {
            ...
            try
            {
                ...
                try
                {
                    hookContext = await evalHooksRunner.RunBeforeAsync(hookContext);
                }
                ...
                await evalHooksRunner.RunAfterAsync(hookContext, variable);
            }
            catch (Exception e)
            {
                ...
                await evalHooksRunner.RunErrorAsync(hookContext, e);
            } finally
            {
                await evalHooksRunner.RunFinallyAsync(hookContext, variable);
            }
